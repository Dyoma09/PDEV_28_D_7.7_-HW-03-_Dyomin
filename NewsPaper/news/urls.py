...
from .views import  ListNews, ListNewsSearch, DetailNews, CreateNews, UpdateNews, DeleteNews, ArticleCreate, ArticleUpdate, ArticleDelete

urlpatterns = [
    path('news/', ListNews.as_view(), name='news'),
    path('news/search/', ListNewsSearch.as_view(), name='new'),
    path('news/<int:pk>', DetailNews.as_view(), name='news_search'),
